        ...
        <div className="mt-8 w-full max-w-[34rem] md:max-w-[46rem] lg:max-w-[52rem]">
          <div className="flex flex-wrap items-center gap-x-5 gap-y-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-robert-regular text-[11px] text-blue-40/25 sm:text-xs">
        ...
        <div className="mt-10 w-full max-w-[34rem] md:max-w-[46rem] lg:max-w-[52rem]">
          ...
          <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="font-robert-regular text-[10px] text-blue-40/25 sm:text-[11px]">
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              >
                {/* blinking cursor */}
                <span className="animate-pulse font-general text-[20px] text-blue-40/60">
                  _
                </span>
                <span className="font-general text-[10px] tracking-[0.2em] text-blue-40/50 transition-colors group-hover:text-blue-300/80">
                  ClassNotFound
                </span>
                {/* trailing slash — dev nod */}
                <span className="font-general text-[10px] text-blue-40/20 group-hover:text-blue-300/40">
                  /&gt;
                </span>
              </a>
            </div>
